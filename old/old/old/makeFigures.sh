...
FOLDERS=($(find /lustre19/expphy/volatile/halld/home/ehingerl/jpsi/trees/v7/PoverE3/m3_p2_sigma/ -name "data_tree_D.root"))
...
for j in ${!FOLDERS[@]}; do
  ...
  for i in ${!Targets[@]}; do
    ...
    root -q -b 'makeFigs2.C("'${INPUTFILE}'","'${TREE}'","'${TreeNames[$i]}'")' &
  done
