...
void makeFigsTemp(string inFileName, string outFileName, string treeName = "e_e_p_X")
{
...
//  h_bCal_PoverE.Write();
  ...
  TH1D h_missingMomentum_proton = *rdf_final.Histo1D(E_miss_model,"p_miss_stat_p","accidweight");
